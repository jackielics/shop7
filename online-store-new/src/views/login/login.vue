     ...
     <!--        <div class="error btns login-form-tips" id="jsLoginTips" v-show="error"><p>用户名或密码错误</p></div> -->
          ...
          <ul class="form other-form">
            ...
            <li class="other-login">
              <a class="qq" href="http://47.115.45.50/login/qq/"></a>
              <a class="sina" href="http://47.112.116.110/login/weibo/"></a>
              <a class="weixin" href="http://47.115.45.50/login/weixin/"></a>
            </li>
          </ul>
          <p class="form-p">
            没有帐号？
    ...
    methods:{
      ...
      login({
          ...
          password:this.parseWord
            ...
            cookie.setCookie('token',response.data.token,7)  //用来存储token
            //存储在store
            // 更新store数据
