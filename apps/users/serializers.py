...
class UserRegSerializer(serializers.ModelSerializer):
    ...
    def validate_code(self, code):
        ...
        if verify_records:
            last_record = verify_records[0] #拿最新的验证码
            ...
            raise serializers.ValidationError("验证码错误")
    #validate作用于所有字段，因为我们想直接将用户名赋值给手机号，
    # 这也是我们在models中设计mobile可以为空的原因
...
from shop7.settings import REGEX_MOBILE
